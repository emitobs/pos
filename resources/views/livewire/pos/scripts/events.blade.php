<script>
    document.addEventListener('DOMContentLoaded',function(){
        ...
        // //ACA USA EL LOCAL STORAGE PARA CARGAR LOS
        // //PEDIDOS QUE NO FUERON COMPLETADOS CON UN METODO DE PAGO

        // let pedidosSinGuardar = getOrdersNotSavedFromLocalStorage();
        // if(pedidosSinGuardar){
        //     pedidosSinGuardar.forEach(pedido => {
        //         console.log(pedido)
        //     });
        // }

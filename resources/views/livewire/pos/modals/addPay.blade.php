    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select wire:model='payment_method_selected' id="payment_method_selected" class="form-control basic">
                ...
                <div class="form-group mt-2">
                    ...
                    <input wire:keydown.enter='addPay()' wire:ignore.self type="number" class="form-control" wire:model="amount" id="amount" required="">
                </div>

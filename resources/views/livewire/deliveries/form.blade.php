...
<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
            <input type="text" wire:model.lazy="name" class="form-control" placeholder="Nombre delivery">
            @error('name') <span class="text-danger er">{{$message}}</span>@enderror
        </div>
        <div class="form-group">
            <input type="text" wire:model.lazy="telephone" class="form-control" placeholder="Teléfono delivery">

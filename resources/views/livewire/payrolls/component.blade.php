                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button wire:click="viewPayroll({{$payroll->id}})"
                                            class="btn btn-primary mtmobile" title="Ver planilla"><i
                                                class="fas fa-chart-bar"></i> Ver reportes</button>
                                        <a href="/pedidos?payroll={{$payroll->id}}" class="btn btn-secondary mtmobile"
                                            title="Ver pedidos"><i class="fas fa-eye"></i> Ver pedidos</a>
                                        @if(!$payroll->isClosed)

...
class ReportsdaysController extends Component
{
    public $totalSales,
        $total,
        $totalCashx,
    ...
    public function render()
    {
        ...
        return view('livewire.reportsday')->extends('layouts.theme.app')
            ->section('content');;
    }
    ...
    public function generate_report($date_option = null, $date)
    {
        ...
        switch ($date_option) {
            ...
            case 'month':
                ...
                $sales = Sale::whereMonth('created_at', '=', $month[1])->whereYear('created_at', $month[0])->get();
                break;
            case 'year':
                $sales = Sale::whereYear('created_at', '=', $date)->get();
                break;
        }
